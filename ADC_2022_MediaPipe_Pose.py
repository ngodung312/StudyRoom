    ...
    while cap.isOpened():
        ...
        try:
            ...
            if (angle_right > 30 and angle_right < 165) and (flag_thankyou == "Detected") and (flag_love == "Not Detected"):
                ...
                flag_love = "Not Detected"
                flag_thankyou = "Detected"
                cv2.putText(image, 'Present', (20,60), cv2.FONT_HERSHEY_SIMPLEX, 1, (50,25,25), 4, cv2.LINE_AA)
            ...
            if (angle_right > 165) and (flag_thankyou == "Detected"):
                ...
                flag_love = "Not Detected"
                flag_thankyou = "Not Detected"
            if (angle_right == 0 and angle_right == 75) and (angle_left == 15 and angle_left == 75):

                flag_love = "Detected"
                flag_thankyou = "Not Detected"
                cv2.putText(image, 'Not Present', (20,60), cv2.FONT_HERSHEY_SIMPLEX, 1, (50,25,25), 4, cv2.LINE_AA)
